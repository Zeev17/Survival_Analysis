...
#daysSinceFirstPurch = interger number of day
#boughtAgain = factor ; 1 = had bought again
...
plot(fitKMSimple, conf.int = FALSE,
     xlab = "Time since first purchase", ylab = "Survival function", main = "Survival function with Kaplan-Meier Analysis")
...
plot(fitKMCov, lty = 2:3,
     xlab = "Time since first purchase", ylab = "Survival function", main = "Survival function with Kaplan-Meier Analysis")
legend(90, .9, c("No Voucher", "With Voucher"), lty = 2:3)
